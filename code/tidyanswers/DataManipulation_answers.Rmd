...
Functions like `mean()` do not automatically ignore these `NAs` — so if there’s even one `NA` in the group, the function will return `NA`.  
...
read_csv("C:/Users/lwendling/Desktop/RCourse/Tidyverse/Salary65th_cleaned.csv")

# Read in your data
salary <- read_csv("Salary65th_cleaned.csv")
